...
(function(window) {
    ...
    var StatisticsManager = new Class({
        initialize: function(game) {
            ...
            this.data.totalPointsThisSession = BigInt(hakpoints);
    ...
    var MenuManager = new Class({
        initialize: function(game) {
            this.game = game;
            this.numPoints = BigInt(hakpoints);
        ...
        create: function() {
			...
			var adHTML = "";
			this.game.ui.showMessage("Welcome Hacker! <3 TL.Winx");
        ...
        addPoints: function(killed, pos) {
            var points = BigInt(killed * this.game.multiplier);
    ...
    var BombManager = new Class({
        ...
        blow: function() {
            /*var message = this.game.ui.showMessage("3...", 5000); Removed due spamming
            delay(1000, function() {
                message.innerHTML = "2...";
            }, this);
            delay(2000, function() {
            ...
            delay(1000, this.blowStuffUp, this);
            this.nextBomb = this.bombShowDelay;
        },
